...
<script src="https://threejs.org/build/three.min.js"></script>
    <script src="https://epic.ct8.pl/avatar/three.min.js"></script>
    <script src="https://epic.ct8.pl/avatar/stats.min.js"></script>
    <script src="https://epic.ct8.pl/avatar/OBJLoader.js"></script>
    ...
    scene.add( directionalLight );
        ...
        loader.load( '/shop_storage/assests/shirts/<?php if ($avatar->{"shirt"} > 0) { echo shopItemHash($avatar->{"shirt"}); } else { echo "studsd"; }; ?>.png' , function ( shirtimg ) {
          shirttex.image = shirtimg;
          shirttex.needsUpdate = true;
        } );
        loader.load( '/shop_storage/assests/pants/<?php if ($avatar->{"pants"} > 0) { echo shopItemHash($avatar->{"pants"}); } else { echo "studsd"; }; ?>.png' , function ( pantsimg ) {
