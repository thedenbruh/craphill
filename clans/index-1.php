...
<!DOCTYPE html>
  <head>
    <title>Clans - Alternative Hill</title>
  </head>
  <body>
...
<img src="/storage/clans/'.$thumbnail.'.png">
...
<div class="col-1-1" style="padding-right:0;">
        ...
        if (isset($_GET['search'])) {
          ...
          while($searchRow=$result->fetch_assoc()){ 
            ...
            echo'<a href="/clan?id=' . $group_id . '">
<div class="hover-card clan">
<div class="clan-logo">
<img class="width-100" src="/storage/clans/'.$thumbnail.'.png?v='.time().'">
</div>
