...
$findItem = $conn->query($findItemSQL);
  ...
  ?><!--<div style="clear: both;margin: 10px;width: 142px;display:inline-block;position: relative;">
    <a href="/shop/item?id=<?php echo $itemRow->{"id"};?>">
        ...
        <img id="shopItem" src="/shop_storage/thumbnails/<?php echo $thumbnail; ?>.png?r=<?=time()?>" ></a>
...
<div style="clear:right;float:left;display:inline-block;width:22%;text-align:left;margin-right:2%">
<button onclick="remove(<?php echo "'$potato'"; ?>)" class="button small smaller-text red" style="position:absolute;margin:10px;padding:4px;">-</button>
<div class="profile-card crate"><img src="/shop_storage/thumbnails/<?php echo $thumbnail; ?>.png?c='.rand().'"><div class="ellipsis" style="color: rgb(118, 118, 118); height: 19px;"><?php echo htmlentities($itemRow->{'name'}); ?></div></div>
</div>
        <?php
 } 
  }
