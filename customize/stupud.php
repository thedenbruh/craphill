...
<div class="block">
  <center>
      <div id="avatar"><img src="/avatar/render/avatars/<?php echo $userRow['id']; ?>.png?c=<?php echo $userRow['avatar_id']; ?>"></div>
      <button onClick="avatarRedraw()" class="button small smaller-text blue">Regenerate</button>
      <form action="" method="POST" style="display:inline-block;">
        <input class="button small smaller-text red" type="submit" name="Purge" value="Purge">
      </form>
    </center>
                </div>
            </div>
...
<div class="block">
        ...
        <div id="subsect">
          <h4>Currently Editing: <span id="ce">Head</span></h4>
          </div>
